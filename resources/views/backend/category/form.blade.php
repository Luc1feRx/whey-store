<div class="card-body">
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Nhập tên danh mục"
            id="convert_slug" name="name_category">
        @error('name_category') <span class="error">{{ $message }}</span> @enderror
    </div>
    <div class="form-group">
        <label for="exampleInputPassword1">Slug</label>
        <input type="text" class="form-control" id="slug" name="slug_category"
            id="exampleInputPassword1" placeholder="Nhập slug danh mục">
